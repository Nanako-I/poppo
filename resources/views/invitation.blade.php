...
<head>
    ...
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold mb-4">新規登録のご案内を送る</h1>
        <div class="share-buttons flex justify-center space-x-4 mt-4">
            <a href="#" id="share-email" title="Email" style="font-size: 2em;" class="text-white bg-blue-500 p-2 rounded">
