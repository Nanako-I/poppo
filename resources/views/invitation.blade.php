...
<head>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="share-buttons flex justify-center space-x-4 mt-4">
            <a href="mailto:?subject=新規登録のご案内&body=ご家族に新規登録のご案内を送ります。" id="share-email" title="Email" style="font-size: 2em;" class="text-white bg-blue-500 p-2 rounded">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // シェアするURLを定義
             // "{!! $url !!}";でエスケープを防ぎ、プレーンテキストとしてURLをエンコードする
            const shareUrl =   "{!! $url !!}";
