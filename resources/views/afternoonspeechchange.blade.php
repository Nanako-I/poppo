  ...
  <body>
      ...
      <div class="center-container">
          ...
          <!--<div style="display: flex; align-items: center; margin-left: auto; margin-right: auto; max-width: 300px;">-->
               <h2 style="margin: 0; padding: 0;">{{$person->person_name}}さんの午後活動記録</h2>
            </div>
            ...
            <table border="0" width="100%" cellspacing="3" cellpadding="0">
                ...
                @php
                $lastSpeech = $person->speeches->whereNotNull('afternoon_activity')->last();
                @endphp
    ...
    <form action="{{ url('afternoonspeech/'.$person->id.'/edit') }}" method="POST">
      @csrf
        <div style="display: flex; flex-direction: column; align-items: center; margin: 10px 0;">
            ...
            <textarea id="recognitionResult" name="afternoon_activity" class="w-full max-w-lg font-bold" style="height: 300px;">{{ $lastSpeech->afternoon_activity }}</textarea>
