...
const ctx3Exist = document.getElementById("temperatureChart");
if (ctx3Exist) {
...
const ctx4Exist = document.getElementById("benChart");
if (ctx4Exist) {
    ...
    // JSON.parse は、JavaScriptでJSON形式の文字列をJavaScriptオブジェクトに変換するための組み込みの関数↓
    const benchartLabels = JSON.parse(
        benChartElement.getAttribute("data-ben-labels")
    );
    ...
    const bentsuuData = JSON.parse(
        benChartElement.getAttribute("data-ben-bentsuu")
    );
...
document.addEventListener("DOMContentLoaded", function () {
    const ctx5Exist = document.getElementById("benConditionChart");
    if (ctx5Exist) {
        const ctx5 = document
            .getElementById("benConditionChart")
            .getContext("2d");
        // JSON.parse は、JavaScriptでJSON形式の文字列をJavaScriptオブジェクトに変換するための組み込みの関数↓
        // const benchartData = JSON.parse(benChartElement.getAttribute("data-ben-data"));
        const benConditionChartElement =
            document.getElementById("benConditionChart");
        const benLabelData = JSON.parse(
            benConditionChartElement.getAttribute("data-ben-labels")
        );
        const benConditionData = JSON.parse(
            benConditionChartElement.getAttribute("data-ben-condition")
        );
        ...
        if (benLabelData) {
            const conditionColors = benConditionLabels.map(
                (label) => colors[label] || defaultColor
            );
...
const ctx6Exist = document.getElementById("foodChart");
if (ctx6Exist) {
    const ctx6 = document.getElementById("foodChart").getContext("2d");
    const foodchartElement = document.getElementById("foodChart");

    // JSON.parse は、JavaScriptでJSON形式の文字列をJavaScriptオブジェクトに変換するための組み込みの関数↓
    const foodchartLabels = JSON.parse(
        foodchartElement.getAttribute("data-food-labels")
    );
    const foodStapleData = JSON.parse(
        foodchartElement.getAttribute("data-staple_food")
    );
    const foodSideDish = JSON.parse(
        foodchartElement.getAttribute("data-side_dish")
    );
